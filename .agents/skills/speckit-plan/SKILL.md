...
2. **Define interface contracts** (if project has external interfaces) → `/contracts/`:
   ...
   - For third-party data inputs, also define the provider-neutral contract owned by the project;
     keep provider payloads and proprietary fields outside domain and business contracts
